...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "top rated makeup artist Mumbai",
    "freelance makeup artist Mumbai",
    // Vasai Virar keywords
    "makeup artist Vasai Virar",
    "bridal makeup artist Vasai",
    "bridal makeup artist Virar",
    "best makeup artist Vasai Virar",
    "wedding makeup Vasai Virar",
    "engagement makeup Vasai Virar",
    "party makeup artist Vasai Virar",
    "makeup classes Vasai Virar",
    "bridal makeup near Vasai",
    "makeup artist Nallasopara",
    "makeup artist Nalasopara",
    // Culture specific
    "Marathi bridal makeup",
    "South Indian bridal makeup Mumbai",
    "Bengali bridal makeup Mumbai",
    "Muslim bridal makeup Mumbai",
    "Christian bridal makeup Mumbai",
    // Event specific
    "haldi makeup artist",
    "mehendi makeup artist Mumbai",
    "pre wedding makeup Mumbai",
    "reception makeup artist Mumbai",
    ...
    // Long tail
    "bridal makeup with hair styling Mumbai",
    "makeup artist for destination wedding India",
    "certified makeup classes Mumbai",
    "learn makeup course Mumbai",
    "makeup academy Vasai Virar",
  ],
  openGraph: {
